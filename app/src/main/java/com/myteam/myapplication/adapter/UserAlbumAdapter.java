...
public class UserAlbumAdapter extends RecyclerView.Adapter<UserAlbumAdapter.MyViewHolder>{
    ...
    public UserAlbumAdapter(Context context, int resource,  ArrayList<Album> malbums) {
    ...
    @NonNull
    @Override
    public UserAlbumAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View item = mLayoutInflater.inflate(mResource, parent,false);
        return new UserAlbumAdapter.MyViewHolder(item);
    }

    @Override
    public void onBindViewHolder(@NonNull UserAlbumAdapter.MyViewHolder holder, int position) {
